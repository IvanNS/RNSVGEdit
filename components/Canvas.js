...
import { canvasContext, CanvasContextProvider } from './CanvasContext.js'
...
const Canvas = ({ svgContent, locale, svgUpdate, onClose, log }) => {
  ...
  return (
    <>
      ...
      <View className="OIe-editor" role="main">
        <View className="workarea">
          <View ref={svgcanvasRef} className="svgcanvas" style={{ position: 'relative' }} />
        </View>
      </View>
